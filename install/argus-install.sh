...
service:
  ...
  Thundernerd/ProxmoxVE:
    latest_version:
      type: github
      url: Thundernerd/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/Thundernerd/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/Thundernerd/ProxmoxVE/releases
EOF
